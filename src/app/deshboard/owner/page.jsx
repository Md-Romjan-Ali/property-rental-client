...
const OwnerPage = async () => {
    ...
    const totalBookingPrice = bookingData.reduce((sum, item) => sum + Number(item.price), 0)
                ...
                <div className="bg-white rounded-2xl p-6 shadow border">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold mt-2">${totalBookingPrice}</h2>
                        </div>
